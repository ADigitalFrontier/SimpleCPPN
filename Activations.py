"""
Originally from https://github.com/CodeReclaimers/neat-python
"""
...
label_map = {
    ...
    'sin_activation': "sin",
    'gauss_activation': "gauss",
    'relu_activation': "relu",
    'elu_activation': "elu",
    'lelu_activation': "lelu",
    'selu_activation': "selu",
    'softplus_activation': "softplus",
    'identity_activation': "identity",
    'clamped_activation': "clamped",
    'inv_activation': "inv",
    'log_activation': "log",
    'exp_activation': "exp",
    'abs_activation': "abs",
    'hat_activation': "hat",
    'square_activation': "square",
    'cube_activation': "cube"
}


def get_func_label(f_name):
    return label_map[f_name]
...
class ActivationFunctionSet(object):
    ...
    def get_random(self):
        return random.choice(list(self.functions.values()))
